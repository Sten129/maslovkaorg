<?php 
/* Template Name: Выставки (прошедшие) */
get_header(); 
...
<main id="page">
	<div class="wrapper">
		<div id="filter-toggle">
			<a href="/выставки-активные" class="btn-ghost">Текущие</a>
		...
		<div class="expansion_container expansion_inactive">
